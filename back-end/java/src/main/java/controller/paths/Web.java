...
public class Web {
    //basic resources
    public static final String checkLogin = "/api/checkLogin";
    ...
    public static final String getCarColors = "/api/bay/search";
    public static final String getCarMakes = "/api/bay/search";
    public static final String getCarLocations = "/api/bay/search";
